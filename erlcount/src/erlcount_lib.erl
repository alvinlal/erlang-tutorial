...
%% recursively searches the given root directory and adds the path of each file to a queue, if Name is a regular file , searches for the string , if Name is a directory, calls find_erl for each file on the directory
find_erl(Name, Queue) ->
